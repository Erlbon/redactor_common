...
def test_rename_pattern():
    ...
    assert rename_pattern.zero_pad_numeric_value("7", width=3) == "007"
    assert rename_pattern.zero_pad_numeric_value("7", width=4) == "0007"
    assert rename_pattern.zero_pad_numeric_value("5.5", width=4) == "0005.5"
